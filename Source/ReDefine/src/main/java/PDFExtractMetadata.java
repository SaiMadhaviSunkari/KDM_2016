 ...
 * 
 */
public final class PDFExtractMetadata
{
    private static PDFExtractMetadata obj=null;
    private PDFExtractMetadata()
    {
        // utility class
    }
     ...
     */
    private static void usage() throws IOException, XmpParsingException {
        String[] inputFiles= new String[] {"data/researchArticles/A Large-Scale Empirical study on software reuse in mobile apps.pdf"};
        //System.err.println("Usage: java " + PDFExtractMetadata.class.getName() + " <input-pdf>");



    }
    public static PDFExtractMetadata objectcreationmethod(){
        if(obj==null){
            obj= new PDFExtractMetadata();
        }
        return obj;
